...
namespace MessengerData
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                x.HasKey(x => new { x.MessageDate, x.MessageGuid, x.CommentedMessageDate, x.CommentedMessageGuid });
                x.HasOne(x => x.Message).WithOne().HasForeignKey<MessageComment>(x => new { x.MessageDate, x.MessageGuid }).OnDelete(DeleteBehavior.Cascade);
